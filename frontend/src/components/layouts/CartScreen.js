                                ...
                                {cartItems.map(item => (
                                    ...
                                    <div>
                                        ...
                                        <div className="d-flex justify-content-between align-items-center">
                                            <div>
                                                <a href="#del" onClick={() => removeCartBtn(item.product)} type="button" className="card-link-secondary small text-uppercase mr-3"><i
                ...
                <div className="mb-3">
                    ...
                    <div className="mb-3">
                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            <span><strong>Rs. {cartItems.reduce((acc, item) => acc + item.qty * item.price, 0).toFixed(2)}</strong></span>
                            </li>
                        </ul>
